            ...
            <div class="row">
                <div class="col-md-12 col-lg-8">
                    <div class="title-single-box">
                        <h1 class="title-single">BAŞLIK</h1>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="news-img-box">
                        <img src="<?= base_url()?>assets/img/slide-3.webp" alt="" class="img-fluid">
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg form-control-a" id="inputName" placeholder="Ad-Soyad *" required>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        <label for="inputEmail1">E-Mail Adresiniz</label>
                                        <input type="email" class="form-control form-control-lg form-control-a" id="inputEmail1" placeholder="E-Mail *" required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        <label for="inputUrl">Website adresiniz</label>
                                        <input type="url" class="form-control form-control-lg form-control-a" id="inputUrl" placeholder="Website">
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        <label for="textMessage">Yorumunuz</label>
                                        <textarea id="textMessage" class="form-control" placeholder="Yorum *" name="message" cols="45" rows="8" required></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
