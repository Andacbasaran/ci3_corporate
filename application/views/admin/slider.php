            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="color: white">Slider Görselleri</h3>
                        <a href="<?= base_url("admin/slider/ekle")?>">
                    ...
                    <div class="card-body">
                        <table id="bloglar" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <?php foreach ($sliders as $slidersirala): ?>
                                <tr>
                                    <td style="color: white"><?= $slidersirala->id; ?></td>
                                    <td style="color: white"><?= $slidersirala->status; ?></td>
                                    <td style="color: white"><?= $slidersirala->sort; ?></td>
                                    <td style="color: white"; width="15%"> <?= $slidersirala->datetime; ?> </td>
                                    <td style="width: 12%">
                                        <a href="<?= base_url('admin/' . $slidersirala->id); ?>" class="btn btn-outline-primary"><i class="fa-solid fa-eye" style="color: white"></i></a>
                                        <a href="<?= base_url('blog/delete_blog/' . $slidersirala->id); ?>" class="btn btn-outline-primary"><i class="fa-regular fa-trash-can fa-lg" style="color: red"></i></a>
                                        <a href="<?= base_url('admin/' . $slidersirala->id); ?>" class="btn btn-outline-primary"><i class="fa-solid fa-pen-to-square fa-lg" style="color: green"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
